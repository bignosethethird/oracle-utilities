...
begin
  ...
  -- Test statements  
  v:=utl.xml.get_attributes('<?xml version="1.0" encoding="UTF-8"?><VENOM><VRM VRM="String" Time="2001-12-17T09:30:47-05:00" F="0" S="0" I="0"><In><User ID="String"/><Img P="0" O="0"/><Conf V="0"/><Op S="String"/><GPS><OS E="4294967295" N="74635241"/><NMEA S="String"/></GPS></In><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit></VRM></VENOM>',
  'Hotlist','/VENOM/VRM/Hit');
  for i in v.first..v.last loop
    dbms_output.put_line(v(i));  
  end loop;

  v:=utl.xml.get_attributes('<?xml version="1.0" encoding="UTF-8"?><VENOM><VRM VRM="String" Time="2001-12-17T09:30:47-05:00" F="0" S="0" I="0"><In><User ID="String"/><Img P="0" O="0"/><Conf V="0"/><Op S="String"/><GPS><OS E="4294967295" N="74635241"/><NMEA S="String"/></GPS></In><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit></VRM></VENOM>',
  'E','/VENOM/VRM/In/GPS/OS');
  for i in v.first..v.last loop
    dbms_output.put_line(v(i));  
  end loop;

  v:=utl.xml.get_attributes('<?xml version="1.0" encoding="UTF-8"?><VENOM><VRM VRM="String" Time="2001-12-17T09:30:47-05:00" F="0" S="0" I="0"><In><User ID="String"/><Img P="0" O="0"/><Conf V="0"/><Op S="String"/><GPS><OS E="4294967295" N="74635241"/><NMEA S="String"/></GPS></In><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit></VRM></VENOM>',
  'N','/VENOM/VRM/In/GPS/OS');
  for i in v.first..v.last loop
    dbms_output.put_line(v(i));  
  end loop;
  
  -- This tries to get an XML fragment and will not work
  v:=utl.xml.get_attributes('<?xml version="1.0" encoding="UTF-8"?><VENOM><VRM VRM="String" Time="2001-12-17T09:30:47-05:00" F="0" S="0" I="0"><In><User ID="String"/><Img P="0" O="0"/><Conf V="0"/><Op S="String"/><GPS><OS E="4294967295" N="74635241"/><NMEA S="String"/></GPS></In><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit></VRM></VENOM>',
  null,'/VENOM/VRM/Hit/Data/text()');
  for i in v.first..v.last loop
    dbms_output.put_line(v(i));  
  end loop;
  v:=utl.xml.get_attributes('<?xml version="1.0" encoding="UTF-8"?><VENOM><VRM VRM="String" Time="2001-12-17T09:30:47-05:00" F="0" S="0" I="0"><In><User ID="String"/><Img P="0" O="0"/><Conf V="0"/><Op S="String"/><GPS><OS E="4294967295" N="74635241"/><NMEA S="String"/></GPS></In><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit><Hit Hotlist="String" F="0" S="0"><Alert F="1"/><Text S="String"/><Desc S="String"/><Data>Text</Data></Hit></VRM></VENOM>',
